...
class PlaygroundXMessagingService : FirebaseMessagingService() {
    ...
    private fun sendNotification(message: RemoteMessage.Notification) {
        ...
        val intent = Intent(this, PlaygroundXActivity::class.java).apply {
    ...
    override fun onNewToken(token: String) {
        ...
        Timber.tag("FCM").d("DeviceToken: %s", token)
    }
